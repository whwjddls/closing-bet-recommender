...
- **백테스트 6개월(2026-01~06) 실측**: 정지종목 0원 행 정제 후 s_신 단독 rank-IC **+0.021, t=2.43**(수용기준 IC>0·t>2 충족, 생존편향 소스 미확보로 공식판정은 DOWNSCOPE 유지) · 정제 전 t 0.32는 데이터 오염이었음 · **CLV(윗꼬리) 가점 아이디어는 기각**(IC −0.06~−0.09, t −4~−9로 역방향) (2026-07-04)

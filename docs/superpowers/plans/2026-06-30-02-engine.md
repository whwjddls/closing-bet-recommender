...
@pytest.mark.parametrize(
    "rvol, expected",
    [(1.0, 0.0), (3.0, 1.0), (9.0, 1.0), (0.5, 0.0), (2.5, 0.834201)],
)
...
def test_rvol_confirm_worked_example():
    assert rvol_confirm(2.5) == pytest.approx(0.933680, abs=1e-5)
...
def test_core_is_product_of_three_axes():
    assert core_score(1.164096, 0.933680, 1.032) == pytest.approx(1.1217, abs=1e-3)


def test_worked_example_kosdaq_a_core():
    # s_신=1.164096, rvol_confirm=0.933680, supply_tilt=1.032 → core≈1.122 (등급 S)
    core = core_score(1.164096, 0.933680, 1.032)
...
def test_worked_example_kosdaq_a_end_to_end():
    ...
    assert row.rvol_confirm == pytest.approx(0.933680, abs=1e-5)
